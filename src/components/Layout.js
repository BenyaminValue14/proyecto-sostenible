              ...
              <div className="row">
                  <div className="col-md-6">
                      <div className="copyright">
                          <p className="copy-text">Copyright © 2023 <strong>Agro Educa</strong> Hecho con ❤ por <a style={{display: 'inline'}} target="_blank" rel="noreferrer" href='https://www.benyaroot.com'>Benyaroot</a>
                         </p>
                      </div>
                  </div>
                  <div className="col-md-6">
